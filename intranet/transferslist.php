...
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('C1','SENDER FIRST NAME');
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('D1','SENDER LAST NAME');
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('E1','TELEPHONE');
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('F1','AMOUNT GBP');
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('G1','FEES GBP');
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('H1','TOTAL GBP DUE');
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('I1','RECEIPIENT FIRST NAME');
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('J1','RECEIPIENT LAST NAME');
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('K1','BANK');
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('L1','ACCOUNT NO');
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('M1','AMOUNT RECEIVED');
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('N1','STATUS');
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('O1','PAYMENT TYPE');
...
$objPHPExcel->setActiveSheetIndex(0)->setCellValue($cellAlias,$mobile);
...
$objPHPExcel->setActiveSheetIndex(0)->setCellValue($cellAlias,$row['recipientfirstname']);

$cellAlias = PHPExcel_Cell::stringFromColumnIndex(9).$counter;
$objPHPExcel->setActiveSheetIndex(0)->setCellValue($cellAlias,$row['recipientsurname']);

$cellAlias = PHPExcel_Cell::stringFromColumnIndex(10).$counter;
$objPHPExcel->setActiveSheetIndex(0)->setCellValue($cellAlias,$row['bankname']);


$cellAlias = PHPExcel_Cell::stringFromColumnIndex(11).$counter;
$objPHPExcel->setActiveSheetIndex(0)->setCellValue($cellAlias,$row['bankac']);
...
$objPHPExcel->setActiveSheetIndex(0)->setCellValue($cellAlias,$row['paymentref']);
$counter = $counter +1;
...
<table class="table table-bordered " style="font-size:70%"id="{{key}}" >
 ...
 <thead>
   ...
   <tr>
        ...
        <th style='tablecells'>S FIRST NAME</th>
        <th style='tablecells'>S LAST NAME</th>
        <th style='tablecells'>TELPHONE</th>
        <th style='tablecells'>AMOUNT &pound;</th>
        <th style='tablecells'>FEES &pound;</th>
        <th style='tablecells'>TOTAL GBP DUE &pound;</th>
        <th style='tablecells'>R FIRST NAME</th>
        <th style='tablecells'>R LAST NAME</th>
        <th style='tablecells'>BANK</th>
        <th style='tablecells'>ACCOUNT NO</th>
        <th style='tablecells'>TOTAL NGN DUE</th>
        <th style='tablecells'>STATUS</th>
        <th style='tablecells'>PAYMENT TYPE</th>
       ...
       <tbody>
        ...
        <td style='tablecells'>{{daily.sendermobile}}</td>
        <td style='tablecells'>{{tocurrency(daily.amount)}}</td>
        <td style='tablecells'>{{tocurrency(daily.fee)}}</td>
        <td style='tablecells'>{{tocurrency(daily.totalgbp)}}</td>
        <td style='tablecells'>{{daily.recipientfirstname}}</td>
        <td style='tablecells'>{{daily.recipientsurname}}</td>
        <td style='tablecells'>{{daily.bankname}}</td>
        <td style='tablecells'>{{daily.bankac}}</td>
        <td style='tablecells'>{{tocurrency(daily.ngn)}}</td>
        <td style='tablecells'>{{daily.status}}</td>
        <td style='tablecells'>{{daily.paymentref}}</td>
