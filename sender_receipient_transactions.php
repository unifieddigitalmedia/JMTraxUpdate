...
$http.get("api/sender_receipient_transactions.php?username="+getCookie('sender_username')+"&firstname="+getCookie('receipient_firstname')+"&lastname="+getCookie('receipient_lastname')+"&usertype=customer" ).then(function(response) {
